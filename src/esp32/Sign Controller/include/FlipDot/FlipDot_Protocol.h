...
#define FLIPDOT_MSG_TYPE_DEFAULT 0x00
#define FLIPDOT_MSG_TYPE_SEND_DATA 0x00
#define FLIPDOT_MSG_TYPE_DATA_CHUNKS_SENT 0x01
#define FLIPDOT_MSG_TYPE_HELLO 0x02
#define FLIPDOT_MSG_TYPE_GOODBYE 0x02
#define FLIPDOT_MSG_TYPE_QUERY_STATE 0x02
...
#define FLIPDOT_DATA_HELLO 0xff
#define FLIPDOT_DATA_GOODBYE 0x55
#define FLIPDOT_DATA_QUERY_STATE 0x00
...
#define FLIPDOT_OPS_ACK_RECEIVE_CONFIG 0x95
#define FLIPDOT_OPS_REQUEST_RECEIVE_PIXELS 0xa2
#define FLIPDOT_OPS_ACK_RECEIVE_PIXELS 0x91
#define FLIPDOT_OPS_REQUEST_SHOW_LOADED_PAGE 0xa9
#define FLIPDOT_OPS_ACK_SHOW_LOADED_PAGE 0x95
#define FLIPDOT_OPS_REQUEST_LOAD_NEXT_PAGE 0xaa
#define FLIPDOT_OPS_ACK_LOAD_NEXT_PAGE 0x97
#define FLIPDOT_OPS_REQUEST_START_RESET 0xa6
#define FLIPDOT_OPS_ACK_START_RESET 0x93
#define FLIPDOT_OPS_REQUEST_FINISH_RESET 0xa7
#define FLIPDOT_OPS_ACK_FINISH_RESET 0x94
...
FlipDotPacket FlipDotPacket_Discovery = {.msgType = FLIPDOT_MSG_TYPE_HELLO, .msgData = {FLIPDOT_DATA_HELLO}};

FlipDotPacket FlipDotPacket_Goodbye = {.msgType = FLIPDOT_MSG_TYPE_GOODBYE, .msgData = {FLIPDOT_DATA_GOODBYE}};

FlipDotPacket FlipDotPacket_Query_State = {.msgType = FLIPDOT_MSG_TYPE_QUERY_STATE, .msgData = {FLIPDOT_DATA_QUERY_STATE}};
